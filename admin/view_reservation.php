   ...
   <div class="payment-summary">
     <div class="summary-card" style="background: #f1f5f9;">
        ...
        <div class="amount" style="color: #1e293b;">
             <?php echo $currencySymbol; ?> <?php echo number_format($total_amount, 2); ?>
        </div>
     </div>
     <div class="summary-card" style="background: #d1fae5;">
        ...
        <div class="amount" style="color: #065f46;">
             <?php echo $currencySymbol; ?> <?php echo number_format($total_paid, 2); ?>
        </div>
     </div>
     <div class="summary-card" style="background: <?php echo $amount_due > 0 ? '#fef3c7' : '#d1fae5'; ?>;">
        ...
        <div class="amount" style="color: <?php echo $amount_due > 0 ? '#f59e0b' : '#10b981'; ?>;">
             <?php echo $currencySymbol; ?> <?php echo number_format($amount_due, 2); ?>
        </div>
     </div>
   </div>
   ...
   <?php else: ?>
     <div class="table-container">
        <table>
             <thead>
                     <tr>
                                  <th><i class="bi bi-clock"></i> <?php echo t('Date Time'); ?></th>
                                  <th><i class="bi bi-wallet2"></i> <?php echo t('Payment Method'); ?></th>
                                  <th><i class="bi bi-cash"></i> <?php echo t('Amount'); ?></th>
                                  <th><i class="bi bi-info-circle"></i> <?php echo t('Reference Evidence'); ?></th>
                     </tr>
             </thead>
             <tbody>
                     <?php foreach ($payments as $payment): ?>
                                  <tr>
                                                       <td>
                                                                                         <?php echo date('M d, Y H:i:s', strtotime($payment['created_at'])); ?>
                                                                                         </d>
                                                       <td>
                                                                                         <?php
                                                                                         $method_icon = [
                                                       ...
                                                       <td style="font-weight: bold; color: #10b981;">
                                                                                         + <?php echo $currencySymbol; ?> <?php echo number_format($payment['amount'], 2); ?>
                                                                                         </d>
                                                       <td>
                                                                                         <?php if ($payment['payment_method'] == 'cash'): ?>
                                                                                                                                                <div style="display: flex; align-items: center; gap: 5px;">
                                                                                                                                                                                                                                         <i class="bi bi-person-badge"></i>
                                                                                                                                                                                                                                         <span><strong>Received by:</strong> <?php echo htmlspecialchars($payment['received_by'] ?? 'System'); ?></span>
                                                                                                                                                </div>
                                                                                                                                                <?php if (!empty($payment['notes'])): ?>
                                                                                         ...
                                                                                         <?php elseif ($payment['payment_method'] == 'cliq'): ?>
                                                                                                                                                ...
                                                                                                                                                <?php if (!empty($payment['transaction_id'])): ?>
                                                                                                                                                                                                                                         <div style="font-size: 11px; color: #64748b; margin-top: 5px;">
                                                                                                                                                                                                                                                                                                                                                                                         <i class="bi bi-receipt"></i> Transaction: <?php echo htmlspecialchars($payment['transaction_id']); ?>
                                                                                                                                                                                                                                         </div>
                                                                                                                                                <?php endif; ?>
                                                                                         <?php elseif ($payment['payment_method'] == 'visa'): ?>
                                                                                                                                                ...
                                                                                                                                                <?php if (!empty($payment['transaction_id'])): ?>
                                                                                                                                                                                                                                         <div style="font-size: 11px; color: #64748b; margin-top: 5px;">
                                                                                                                                                                                                                                                                                                                                                                                         <i class="bi bi-upc-scan"></i> Transaction: <?php echo htmlspecialchars($payment['transaction_id']); ?>
                                                                                                                                                                                                                                         </div>
                                                                                                                                                <?php endif; ?>
                                                                                         <?php endif; ?>
             ...
             <tfoot>
                     <tr style="background: #f8fafc; font-weight: bold;">
                                  ...
                                  <td colspan="2"><?php echo $currencySymbol; ?> <?php echo number_format($total_paid, 2); ?></td>
                     </tr>
             </tfoot>
        </table>
     </div>
