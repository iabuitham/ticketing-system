...
<head>
  ...
  * {
  ...
  /* Add these styles to your existing CSS section, preferably near the payment-split-item styles */

  /* Payment Modal Form Elements - Light Mode */
  ...
  .payment-split-item .form-group input:focus,
  .payment-split-item .form-group select:focus {
   outline: none;
  ...
  .payment-split-item .form-group input[type="file"]:hover {
   border-color: <?php echo $themeColor; ?>;
  ...
  /* Payment Modal - Dark Mode Styles */
  ...
  body.dark-mode .payment-split-item .form-group input:focus,
  body.dark-mode .payment-split-item .form-group select:focus {
   border-color: <?php echo $themeColor; ?>;
   box-shadow: 0 0 0 3px rgba(79, 70, 229, 0.2);
  }

  body.dark-mode .payment-split-item .form-group input[type="file"] {
   background-color: #1e293b;
   border-color: #334155;
   color: #94a3b8;
  }

  body.dark-mode .payment-split-item .form-group input[type="file"]:hover {
   border-color: <?php echo $themeColor; ?>;
  ...
  .payment-split-item .form-group {
   margin-bottom: 12px;
  }

  .payment-split-item .form-group:last-child {
   margin-bottom: 0;
  }

  .payment-split-item .form-group label {
   display: block;
   margin-bottom: 6px;
   font-weight: 500;
   font-size: 13px;
  ...
  body.dark-mode .payment-split-item .form-group label {
   color: #94a3b8;
  }

  /* Remove button styling */
  .payment-split-item .btn-danger {
  ...
  .payment-split-item .btn-danger:hover {
   background-color: #dc2626;
  }

  /* Cliq preview image styling */
  .cliq-preview img {
   max-width: 100px;
   max-height: 100px;
   border-radius: 8px;
  ...
  body.dark-mode .cliq-preview img {
   border-color: #334155;
  }

  /* Small helper text styling */
  .payment-split-item small {
   display: block;
   margin-top: 5px;
   font-size: 11px;
   color: #64748b;
  ...
  body.dark-mode .payment-split-item small {
   color: #94a3b8;
  }

  /* Add Payment button styling */
  #paymentModal .btn-secondary.btn-sm {
   background: #64748b;
   color: white;
   border: none;
   padding: 10px;
  ...
  #paymentModal .btn-secondary.btn-sm:hover {
   background: #475569;
  }
  ...
  .payment-split-item input[type="number"]::-webkit-inner-spin-button,
  .payment-split-item input[type="number"]::-webkit-outer-spin-button {
