...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        body.dark-mode .request-info strong {
            color: #94a3b8;
        }
        .dark-mode-toggle {
            position: fixed;
...
<body>
    <div class="error-container">
        <div class="error-card">
            ...
            <h1>400</h1>
            <h2>Bad Request</h2>
            <p>The server could not understand the request due to invalid syntax.<br>
            يبدو أن هناك خطأ في طلبك. يرجى التحقق والمحاولة مرة أخرى.</p>
